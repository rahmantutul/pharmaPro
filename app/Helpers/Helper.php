...
class Helper {
    ...
    public static function convert_number_to_words($num){ 
    ...
    public static function getStoreInfo(){
        return $info = GeneralSetting::first();
    }

    public static function getMedicineStock($medId){
        $stock = Stock::where('expire_date', '>', date('Y-m-d'))->where('medicineId',$medId)->sum('qty');
        return $stock;
    }
