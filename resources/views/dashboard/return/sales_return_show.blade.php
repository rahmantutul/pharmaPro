    ...
    <div class="row mt-4">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
            <div class="return-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="mt-0" style="color: black; font-weight: 700;">SALES RETURN</h2>
                        <p class="mb-0" style="opacity: 0.9;">Invoice #: <strong>{{ $return->inv_no }}</strong></p>
                    </div>
            ...
            <div class="return-body">
                        ...
                        <div class="info-value">
                            @if($return->customer)
                                ...
                                <span style="font-size: 0.9rem; color: #6b7280;">
                                    <i class="fa fa-phone"></i> {{ $return->customer->phone }}<br>
                                    <i class="fa fa-map-marker"></i> {{ $return->customer->address }}
                                </span>
                            @else
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size: 0.8rem; color: #9ca3af;">Supplier: {{ $return->medicine->supplier->name ?? 'N/A' }}</div>
                                </td>
                        ...
                        <tfoot>
                            <tr style="background: #f9fafb;">
                                <td colspan="3" class="text-right" style="font-weight: 700; padding: 20px;">GRAND TOTAL REFUND</td>
                ...
                <div class="row mt-4 pt-4" style="border-top: 1px dotted #e5e7eb;">
                    <div class="col-sm-6 text-muted" style="font-size: 0.85rem;">
                        <p>Note: This is a system generated document. Stock has been adjusted automatically upon processing this return.</p>
                    </div>
                    <div class="col-sm-6 text-right">
                        <a href="{{ route('return.sales.index') }}" class="btn btn-primary">
