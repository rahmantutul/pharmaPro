                ...
                <div class="col-sm-10" style="margin:auto !important;">
                    <div class="panel panel-white">
                        <div class="panel-body">
                                ...
                                <form action="" method="GET" id="myform"> @csrf
                                    <div class="row bg-secondary p-3">
                                        <div class="col-md-4">
                                            <select id="customer" class="form-control single-select" name="customerId">
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option {{ request()->customerId == $customer->id ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a href="{{route('report.customer_due')}}" class="btn btn-sm btn-danger" title="Reset"><i class="fa fa-times"></i></a>
                                        </div>
                            ...
                            <table class="table mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center">{{ __('Total Sales Amount') }}</th>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="panel panel-white" style="border-left: 4px solid #e67e22;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-6 mb-3">
                                                    <div class="summary-item" style="text-align: center; padding: 15px; background: #ecf0f1; border-radius: 8px;">
                                                        <small class="text-muted d-block mb-1">{{ __('Total Sales Amount') }}</small>
                                                ...
                                                <div class="col-md-4 col-sm-6 mb-3">
                                                    <div class="summary-item" style="text-align: center; padding: 15px; background: #fff3cd; border-radius: 8px; border: 2px solid #e67e22;">
                                                        <small class="text-muted d-block mb-1">{{ __('Total Due') }}</small>
                                                        <h4 class="mb-0" style="color: #856404; font-weight: 700;">{{ number_format($grandStats->due_total, 2) }}</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
