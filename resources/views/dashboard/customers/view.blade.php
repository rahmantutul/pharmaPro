        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-sm-5">
                    ...
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h4 class="panel-title text-center">{{ __('Customer Transection') }} <span class="text-bold">
                                    {{ __('View') }}</span></h4>
                        </div>
                ...
                <div class="col-md-7">
                    <div class="panel panel-white">
                        <div class="panel-body">
                            <h4>{{ __("Invoice List") }}</h4><a href="{{ route('customer.index') }}" style="float: right;">{{ __('Go to list') }}</a>
                ...
                <form id="editCategory" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="editCustomerName">{{ __('Amount')}}</label>
                            <input type="number" class="form-control" id="amount" name="amount" required>
                            <input type="hidden" class="form-control" id="custId" name="custId" required>
...
@push('javascript')
    ...
    <script>
        ...
        function createTransection(id, due) {
            var actionUrl = '{{ url("/customer/transaction") }}';
