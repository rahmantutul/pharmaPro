                        ...
                        <div class="panel-body">
                                ...
                                <form action="" method="GET" id="myform"> @csrf
                                    <div class="row bg-secondary p-3">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a href="{{route('stock.expired_medicine')}}" class="btn btn-sm btn-danger" title="Reset"><i class="fa fa-times"></i></a>                                        
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <table class="table mb-0">
                                <thead>
                                    <tr>
                                        <th scope="col">{{__('#')}}</th>
                                        <th scope="col" class="text-center">{{__('Batch')}}</th>
                                        ...
                                        <th scope="col" class="text-center">{{__('Total Expired Qty')}}</th>
                                    </tr>
                                </thead>
                                @php
                                    $total=0; 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td class="text-bold-500 text-center"><b>{{date('j F Y',strtotime($data->expire_date))}}</b></td>
                                        ...
                                        <td class="text-center"><b>{{$data->total_qty}}</b></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
