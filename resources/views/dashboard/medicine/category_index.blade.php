                ...
                <div class="col-sm-5">
                    ...
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h4 class="panel-title text-center">{{ __('Medicine Category')}} <span class="text-bold"> {{ __('Create')}}</span></h4>
                        </div>
            ...
            <div class="modal-content">
                <form id="editCategory" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">{{ __('Edit Medicine Category')}}</h5>
                    </div>
...
<script>
    ...
    function editCategory(id, name) {
        var actionUrl = '{{ url("/medicine/category/update") }}/' + id;
    ...
    $('#CategoryTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('medicine.category.data') }}",
        columns: [
            { data: 'id', name: 'id' },
            { data: 'name', name: 'name' },
